...
<body class="bg-[#FEFEFE] font-sans">
    ...
    <main class="p-6 max-w-3xl mx-auto">
        <h1 class="text-darkPurple text-5xl font-bold mb-6 drop-shadow-lg font-serif">Upload Your Content</h1>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    <textarea id="caption" name="caption" rows="4" class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-mediumSlateBlue" placeholder="Enter your caption here..."></textarea>
                    <button type="button" id="emoji-button" class="absolute right-0 top-0 mt-2 mr-2 text-gray-500 hover:text-mediumSlateBlue focus:outline-none">😊</button>
            ...
            <div>
                <button type="submit" class="w-full p-2 bg-[#121212] font-bold text-white rounded-md hover:bg-darkPurple focus:outline-none focus:ring-2 focus:ring-mediumSlateBlue">
                    Upload
                </button>
            </div>
        </form>
    </main>
    <footer class="bg-darkPurple text-white p-4 text-center font-sans mt-8">
